...
Item {
    ...
    Item {
        ...
        ColumnLayout {
            ...
            ScrollView {
                id: modelBodyScroll
                objectName: "modelSetupBodyScroll"
                ...
                ColumnLayout {
                    objectName: "modelSetupBodyContent"
                    width: modelBodyScroll.availableWidth
                    spacing: 16
            ...
            RowLayout {
                ...
                Button {
                    objectName: "modelSetupFinishButton"
