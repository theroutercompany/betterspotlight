...
Item {
    ...
    Component.onCompleted: onboardingControllerObj.refreshFda()
    ...
    Item {
        ...
        ColumnLayout {
            ...
            ScrollView {
                ...
                ColumnLayout {
                    objectName: "fdaBodyContent"
                    width: fdaBodyScroll.availableWidth
                    spacing: 16
                    ...
                    Rectangle {
                        ...
                        ColumnLayout {
                            ...
                            Label {
                                text: qsTr("2. BetterSpotlight should already be listed")
                                font.pixelSize: 13
                                color: "#666666"
                            }

                            Label {
                                text: qsTr("3. Enable its switch")
                                font.pixelSize: 13
                                color: "#666666"
                            }
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            onClicked: {
                                if (onboardingControllerObj.checkFda()) {
                                    fdaStep.next()
                                }
                            }
                        }
                    ...
                    Label {
                        ...
                        Layout.maximumWidth: 460
                        horizontalAlignment: Text.AlignHCenter
                        text: qsTr("BetterSpotlight is registered before System Settings opens. " +
                        ...
                        RowLayout {
                            ...
                            Label {
                                text: onboardingControllerObj.fdaGranted
                                      ? qsTr("Access granted")
                                      : (onboardingControllerObj.fdaStatusMessage.length > 0
                                         ? onboardingControllerObj.fdaStatusMessage
